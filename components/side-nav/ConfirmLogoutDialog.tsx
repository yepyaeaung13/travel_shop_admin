...
import IconLogoutConfirm from "@/assets/icons/LogoutConfirm";
        ...
        <DialogFooter className="w-full">
          <div className="flex w-full justify-center gap-3">
            <Button
              ...
              disabled={loading}
              className="h-auto w-[47%] rounded-[10px] bg-[#44444480] py-2 text-base text-white md:text-lg"
            >
              Cancel
            </Button>
            <Button
              ...
              onClick={callback}
              disabled={loading}
              className="h-auto w-[47%] rounded-[10px] bg-[#FF3333] py-2 text-base hover:bg-[#FF3333] md:text-lg text-white"
            >
              {loading ? <IconLoading className="size-10" /> : "Log out"}
            </Button>
          </div>
        </DialogFooter>
      </DialogContent>
